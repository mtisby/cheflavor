...
<span style="color:red;"><b>Important!</b></span> to view the staffportal, please login with the user: 123 and pass: 123; If you are using chrome, this prevents the user and pass from being autosaved to your device.
